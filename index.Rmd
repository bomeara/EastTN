...
Use the menu above for information on vaccinations, conditions in schools, and more. This site was last updated on `print(format(Sys.time(), "%I:%M %p on %A %B %d, %Y"))`, though many data sources have a lag of a week or more. 
