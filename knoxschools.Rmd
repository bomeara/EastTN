...
all_schools_knox <- individual_schools_knox %>% group_by(Date, Level) %>% summarize(Student_Enrolled=sum(Student_Enrolled), Student_Present=sum(Student_Present), Staff_Employed=sum(Staff_Employed), Staff_Present=sum(Staff_Present))
