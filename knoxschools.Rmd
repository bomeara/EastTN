...
Using data kindly provided by the [KCS DIY COVID-19 Dashboard](https://kcsdashboard.org/), we can see how long students have gone from having symptoms to getting a positive test result:
