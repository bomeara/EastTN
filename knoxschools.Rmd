...
try(knox_schools_ytd <- ggplot(schools_knox_counts, aes(x=Date, y=Count, group=Population)) + geom_line(aes(colour=Population)) + theme_classic() + ylab("Number of individuals with active covid infections") + xlab("Date") + ggtitle("Covid infections in Knox County Schools, TN"))
...
try(knox_schools_pct <- ggplot(schools_knox_percent, aes(x=Date, y=Percent, group=Population)) + geom_line(aes(colour=Population)) + theme_classic() + ylab("Percent of individuals with active covid infections") + xlab("Date") + ggtitle("Covid infections in Knox County Schools, TN"))
