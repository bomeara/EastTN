...
try(knox_schools_ytd <- ggplot(individual_schools_knox, aes(x=Date, y=Student_Present_Percent, group=School)) + geom_line(aes(colour=School)) + theme_light() + ylab("Percentage of students in attendance") + xlab("Date") + ylim(c(50, 100)) + ggtitle("Student attendance in Knox County Schools") + facet_wrap(~ School, ncol=3) + theme(legend.position = "none") + scale_x_datetime(date_labels = "%b %d"))
print(knox_schools_ytd)
```
...
try(knox_schools_staff_ytd <- ggplot(individual_schools_knox, aes(x=Date, y=Staff_Present_Percent, group=School)) + geom_line(aes(colour=School)) + theme_light() + ylab("Percentage of staff in attendance") + xlab("Date") + ylim(c(50, 100)) + ggtitle("Staff attendance in Knox County Schools") + facet_wrap(~ School, ncol=3) + theme(legend.position = "none") + scale_x_datetime(date_labels = "%b %d"))
