...
The Knox County Health Department puts out information on hospital capacity in their region, which is `r paste0(sort(counties_in_hospital_region), collapse=", ")` Counties; there are 19 hospitals in this region with potential ICU beds.
