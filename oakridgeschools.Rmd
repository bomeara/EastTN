...
Oak Ridge Schools were releasing information on cases in schools; this release, and tracking of cases, stopped in March 2022, so dark gray rectangles are used after that to show the areas where data are lacking. The below plots are based on the data that were released and will be updated if new data appear. You can also get information at https://www.oakridger.com/ and https://oakridgetoday.com/. 
