...
```{r departures, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE}
kable(departures_formatted)
```

### Arrivals

```{r arrivals, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE}
kable(arrivals_formatted)
```